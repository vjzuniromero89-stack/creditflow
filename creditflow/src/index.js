...
async function portalLogin(request, env) {
  ...
  // El mensaje dice específicamente "del portal" (distinto al login de tu equipo, que usa el mismo
  // texto genérico) para que si alguien prueba por error las credenciales de un cliente en la
  // pantalla normal de tu equipo (o al revés), sepa de inmediato que está en la pantalla que no es.
  if (!c || !c.portal_password_hash) return errorJson("Usuario o contraseña del portal incorrectos.", 401);
